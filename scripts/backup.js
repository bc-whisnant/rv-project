...
function renderAquaSection() {
  var aquaSection = document.querySelector(".aqua");
  var aquaPhone = dealersList.dealers[0].data.phone1;
  aquaSection.querySelector("h2").innerHTML = aquaPhone;

  var aquaWeekHours = dealersList.dealers[0].data.weekHours.weekdays;
  aquaSection.querySelector(".hours-weekdays").innerHTML = aquaWeekHours;

  var aquaSatHours = dealersList.dealers[0].data.weekHours.sat;
  aquaSection.querySelector(".hours-saturdays").innerHTML = aquaSatHours;

  aquaSection.querySelector(".hours-sundays").innerHTML = "CLOSED";
}
